      ...
      <section className="w-full max-w-3xl space-y-6">
        <div className="space-y-2">
          ...
          <p className="text-gray-600">
            Bem-vindo ao EchoSafe. Ao usar nosso site, você concorda com estes
            termos. Leia-os atentamente.
          </p>
        </div>
        <div className="space-y-2">
          <h2 className="mb-2 text-2xl font-semibold">Aceitação dos Termos</h2>
          <p className="text-gray-600">
            Ao acessar ou usar nosso site, você indica que leu, entendeu e
            concorda em ficar vinculado a estes termos.
          </p>
        </div>
        <div className="space-y-2">
          <h2 className="mb-2 text-2xl font-semibold">Obrigações do Usuário</h2>
          <h3 className="mt-4 text-xl font-semibold">Atividades Proibidas</h3>

          <p className="text-gray-600">
            Você não pode se envolver em nenhuma das seguintes atividades
            proibidas: spam, hacking ou distribuição de conteúdo não autorizado.
          </p>
          <h3 className="mt-4 text-xl font-semibold">
            Responsabilidades do Usuário
          </h3>
          <p className="text-gray-700 dark:text-gray-300">
            Você é responsável por manter a confidencialidade das informações de
            sua conta e por qualquer atividade que ocorra em sua conta.
          </p>
          <h3 className="mt-4 text-xl font-semibold">
            Conformidade com as Leis
          </h3>
          <p className="text-gray-700 dark:text-gray-300">
            Você deve cumprir todas as leis e regulamentos aplicáveis ao usar
            nosso site.
          </p>
        </div>
        <div className="space-y-2">
