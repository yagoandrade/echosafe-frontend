...
const Header = ({ isLoggedIn }: HeaderProps) => {
  ...
  /* const loggedInHeaderClasses =
    "sticky h-12 flex top-0 z-50 border-b border-[#ffffff14] bg-[#ffffff10] items-center justify-between w-full gap-x-2 px-4 shadow-sm backdrop-blur-md dark:border-[#ffffff14] dark:bg-[#ffffff03] lg:px-12 xl:px-32 2xl:gap-x-12 2xl:px-80"; */
    ...
    <>
      ...
      <header
        className={cn(
          ...
          /* isLoggedIn ? loggedInHeaderClasses : loggedOutHeaderClasses, */
          loggedOutHeaderClasses,
        )}
      >
