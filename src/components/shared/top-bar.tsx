...
const TopBar = () => {
  ...
  return (
    <div className="flex w-full flex-wrap justify-between border-b border-[#e5e6e9] px-4 py-1.5 text-sm font-light text-[#a09b95]  lg:px-12 2xl:gap-x-12 2xl:px-32 2xl:px-80">
